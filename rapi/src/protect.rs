...
//     translation units may be compiled, resulting in unrelated instances of
...
// Source: https://github.com/yutannihilation/unextendr/blob/d757eb998a8bbc686c38f0b7c1a80b967893cf4d/src/rust/src/protect.rs

use once_cell::sync::Lazy;
use rsys::{
  R_NilValue, R_PreserveObject, Rf_cons, Rf_protect, Rf_unprotect, CAR, CDR,
